...
public static class RoleHelpers
{
    ...
    public static bool CanUseVent(this CachedPlayer player) => CanUseVent(player.PlayerControl);
    ...
    {
        var ca = CachedPlayer.AllPlayers.FirstOrDefault(n => n.PlayerControl == player);
    ...
    public static bool Is<T>(this CachedPlayer player) where T : RoleBase => player.PlayerControl.Is<T>();
    ...
    */
    ...
    {
        return RoleInfo.AllRoleInfo.FirstOrDefault(n => n.RoleClassType == typeof(T))!.Color;
    }
    ...
    public static IEnumerable<RoleBase> GetRoles(this CachedPlayer player) => GetRoles(player.PlayerControl);
